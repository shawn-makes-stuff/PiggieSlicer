var LangText = {
  en: {
    ...
    orca3: "Stealth Mode",
    orca4: "PiggieSlicer runs fully offline and never sends your data to any cloud service. It prints over your local network (LAN), so it's safe to leave this enabled.",
