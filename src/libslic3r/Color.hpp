...
public:
    ...
    static const ColorRGB ORCA()		{ return {236.0f / 255.0f, 111.0f / 255.0f, 166.0f / 255.0f}; }
...
public:
    ...
    static const ColorRGBA ORCA()        { return {236.0f / 255.0f, 111.0f / 255.0f, 166.0f / 255.0f, 1.0f}; }
