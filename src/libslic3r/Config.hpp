...
// When parsing a configuration value, if the old_value is not understood by this PiggieSlicer version,
// it is being substituted with some default value that this PiggieSlicer could work with.
