...
#define SLIC3R_APP_FULL_NAME "PiggieSlicer"
#define GCODEVIEWER_APP_NAME "PiggieSlicer G-code Viewer"
#define GCODEVIEWER_APP_KEY  "PiggieSlicerGcodeViewer"
#define GCODEVIEWER_BUILD_ID std::string("PiggieSlicer G-code Viewer-") + std::string(SLIC3R_VERSION) + std::string("-RC")
