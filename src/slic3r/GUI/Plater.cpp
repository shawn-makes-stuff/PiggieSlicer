        ...
        try {
            if (type_3mf) {
                ...
                En3mfType          en_3mf_file_type = En3mfType::From_BBS;
                {
                    ...
                    const wxString msg_unsupported_geometry    = _L("The 3MF is not supported by PiggieSlicer, loading geometry data only.");
                    const wxString msg_old_orca_geometry       = _L("The 3MF file was generated by an old OrcaSlicer/PiggieSlicer version, loading geometry data only.");
                    ...
                    if (en_3mf_file_type == En3mfType::From_Prusa) {
                        ...
                        if (file_version <= orca_tag_start_version) {
                            ...
                            if (load_config && config_loaded.empty()) {
                                ...
                                wxString text = _L("The 3MF was created by BambuStudio. Some settings may differ from PiggieSlicer.");
                                log_and_show_3mf_info(text, bambu_project_title);
                            }
                        }
                    }
