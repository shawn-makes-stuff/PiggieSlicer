...
static std::map<wxColour, wxColour> gDarkColors{
    ...
    //{"#F0F0F0", "#4C4C54"},
    // ORCA
    {"#F9D9E7", "#223C3C"}, // rgb(191, 225, 222)  Dropdown checked item background color > ORCA color with %25 opacity
    {"#FCEAF2", "#283232"}, // rgb(229, 240, 238)  Combo / Dropdown focused background color > ORCA color with %10 opacity
};
