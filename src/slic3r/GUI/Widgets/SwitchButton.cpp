...
SwitchButton::SwitchButton(wxWindow* parent, wxWindowID id)
    ...
    , thumb_color(std::pair{0xEC6FA6, (int) StateColor::Checked}, std::pair{0xD9D9D9, (int) StateColor::Normal})
{
...
ModeSwitchButton::ModeSwitchButton(wxWindow* parent, wxWindowID id)
{
    ...
    border_color = StateColor(
        ...
        std::make_pair(wxColour("#F291BC"), (int) StateColor::Focused),
        std::make_pair(wxColour("#D9D9D9"), (int) StateColor::Normal)
    );
    track_background = StateColor(
        std::make_pair(wxColour("#EC6FA6"), (int) StateColor::Disabled),
        std::make_pair(wxColour("#EC6FA6"), (int) StateColor::Normal)
    );
    track_border = StateColor(
        std::make_pair(wxColour("#D9D9D9"), (int) StateColor::Disabled),
        std::make_pair(wxColour("#EC6FA6"), (int) StateColor::Hovered | ~StateColor::Focused),
        std::make_pair(wxColour("#F291BC"), (int) StateColor::Focused),
        std::make_pair(wxColour("#EC6FA6"), (int) StateColor::Normal)
    );
...
MultiSwitchButton::MultiSwitchButton(wxWindow *parent, wxWindowID id, const wxPoint &pos, const wxSize &size, long style)
    ...
    , m_bg_color(StateColor(
          ...
          std::make_pair(0xEC6FA6, (int) StateColor::Normal)))
...
void SwitchBoard::doRender(wxDC &dc)
{
	...
	/*left*/
    if (switch_left) {
        is_enable ? dc.SetBrush(wxBrush(wxColour(236, 111, 166))) : dc.SetBrush(disable_color);
	...
	/*right*/
    if (switch_right) {
        if (is_enable) {dc.SetBrush(wxBrush(wxColour(236, 111, 166)));
        } else {dc.SetBrush(disable_color);}
